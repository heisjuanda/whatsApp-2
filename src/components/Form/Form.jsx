    ...
    return (
        <>
                                ...
                                <>
                                    ...
                                    >{field?.htmlLabel ? (
                                        <div className='img-avatar'>
                                            <img src={imageRegister} alt='little img references to add an avatar' />
            ...
            <div className='form-change-section'>
                <p>{changeSection?.text} <span onClick={() => { navigate(changeSection?.url) }}>{changeSection?.urlText}</span></p>
            </div>
        </>
    );
};
